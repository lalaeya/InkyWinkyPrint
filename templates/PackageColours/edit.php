...
<div class="row" style="justify-content: center; padding: 40px;">
    ...
    <aside class="column" style="max-width: 220px;">
        <div class="side-nav" style="background-color: #a1c9f4; padding: 30px; border-radius: 20px;">
            ...
            <?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $packageColour->package_colour_id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80" style="max-width: 1200px; width: 100%; padding: 20px;">
        <div class="packageColours form content" style="background-color: #fff; padding: 50px; border-radius: 25px; box-shadow: 0px 8px 16px rgba(0, 0, 0, 0.1);">
            <h3 style="font-size: 2.5rem; color: #ff6f8e; text-align: center; font-weight: bold;"><?= __('Edit Package Colour') ?></h3>
            
            <!-- Form for Editing Package Colour -->
            <?= $this->Form->create($packageColour) ?>
            <fieldset>
                <legend style="font-size: 2rem; color: #ff6f8e; text-align: center; font-weight: bold;"><?= __('Package Colour Details') ?></legend>
                <br>
                <?php
                    echo $this->Form->control('colour_types', [
                        'label' => 'Colour Type', 
                        'class' => 'input-field', 
                        'placeholder' => 'Enter Colour Type',
                    ]);
                ?>
            </fieldset>
            <!-- Submit Button -->
